...
namespace Services
{
    class UserService : Singleton<UserService>, IDisposable
    {
		...
		public UnityEngine.Events.UnityAction<string> OnTest;
        ...
        public UserService()
        {
			...
			MessageDistributer.Instance.Subscribe<TestResponse>(this.OnUserTest);
        ...
        void OnUserTest(object sender, TestResponse response)
        {
            if (this.OnTest != null)
            {
                this.OnTest(response.Welcome);
